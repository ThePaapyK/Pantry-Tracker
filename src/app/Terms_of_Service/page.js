...
const TermsOfService = () => {
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', padding: '30px', lineHeight: '1.8', color: '#333', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h2 style={{ fontSize: '22px', fontWeight: 'bold', marginBottom: '15px' }}>1. Introduction</h2>
      <p style={{ marginBottom: '20px' }}>
        The following terms and conditions apply to your use of Kichin (the "App"). By using the App, you agree to these terms in full. We reserve the right to modify these terms at any time, so please check this page regularly for updates.
      </p>

      <h2 style={{ fontSize: '22px', fontWeight: 'bold', marginBottom: '15px' }}>2. User Accounts</h2>
      <p style={{ marginBottom: '20px' }}>
      ...
      <h2 style={{ fontSize: '22px', fontWeight: 'bold', marginBottom: '15px' }}>3. User Responsibilities</h2>
      <p style={{ marginBottom: '20px' }}>
      ...
      <ul style={{ marginBottom: '20px', paddingLeft: '20px', listStyleType: 'disc' }}>
        ...
        <li style={{ marginBottom: '10px' }}>
          Not use the app in any way that may impair its functionality or interfere with other users.
        </li>
        <li style={{ marginBottom: '10px' }}>
          Provide accurate and complete information when creating an account or using the app.
        </li>
      </ul>
      ...
      <p style={{ marginBottom: '20px' }}>
        We reserve the right to suspend or terminate your access to the app at our discretion, without prior notice or liability, if you violate these terms.
      </p>
      ...
      <p style={{ marginBottom: '20px' }}>
        We may modify these terms at any time. Any changes will be effective immediately upon posting to the app. By continuing to use the app after any modifications, you agree to the updated terms.
      </p>
      ...
      <p style={{ marginBottom: '20px' }}>
        If you have any questions about these terms, please contact us at pkeannan77@gmail.com.
      </p>
    </div>
  );
};
